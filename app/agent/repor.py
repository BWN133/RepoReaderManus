...
class Repor(BrowserAgent):
    """
    A Specified Agent that guides human on how to understand large repository
    ...
    name: str = "Repor"
    description: str = (
        "A specified Agent that guides human on how to understand large repsository"
    )
